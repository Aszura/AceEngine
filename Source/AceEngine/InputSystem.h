...
private:
	static std::bitset<static_cast<size_t>(Key::KeyCount)> mKeys;
	static std::bitset<static_cast<size_t>(Key::KeyCount)> mLastKeys;
	static std::bitset<static_cast<size_t>(MouseButton::ButtonCount)> mMouseButtons;
	static std::bitset<static_cast<size_t>(MouseButton::ButtonCount)> mLastMouseButtons;
