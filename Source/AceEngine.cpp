...
{
	AceEngine engine;
	engine.run(hInstance, hPrevInstance, lpCmdLine, nCmdShow);
}

int AceEngine::run(HINSTANCE hInstance, HINSTANCE hPrevInstance,
	LPSTR lpCmdLine, int iCmdShow)
{
	...
	wc.lpszClassName = L"AceEngine";
	RegisterClass(&wc);

	// create main window
	hWnd = CreateWindow(
		L"AceEngine", L"Ace Engine",
